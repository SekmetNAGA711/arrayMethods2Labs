...
// CODE HERE
const divideNumber = numbers.map(function(num){
  return num / 2
})
...
// CODE HERE
let cityEndsI = cities.filter(function(element){
  return element.endsWith("i")
})
console.log(cityEndsI)
////////// PROBLEM 4 //////////
...
// CODE HERE
let totalRice = foods.filter(function(elem){
  return elem.tags.includes("rice")
